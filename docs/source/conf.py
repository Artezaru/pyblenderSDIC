...
def read_version():
    version_file = os.path.join(os.path.dirname(__file__), '..', '..', 'pyblenderSDIC', '__version__.py')
    with open(version_file, "r") as file:
        exec(file.read()) 
    return locals()["__version__"]

project = "pyblenderSDIC"
...
latex_documents = [
    ("index", "pyblenderSDIC.tex", "pyblenderSDIC Documentation",
     "Artezaru", "manual"),
]
